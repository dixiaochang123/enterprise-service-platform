<template>
  <div class="personal">
    ...
    <div class="box">
      <div class="box-main">
        <p class="p1"><span></span><span style="visibility: hidden;"></span>加大援企稳岗力度</p>
        <p class="p2">对职工因疫情接受治疗或被医学观察隔离期间企业所支付的工资待遇，按照不超过基本养老保险缴纳技术的50%补贴企业。</p>
        <p class="p3"><span></span> 责任部门</p>
        <p class="p4">常州市人力资源和社会保障局</p>
        <p class="p3"><span></span> 责任部门</p>
        <p class="p4">常州市人力资源和社会保障局</p>
        <p class="p3"><span></span> 责任部门</p>
        <p class="p4">常州市人力资源和社会保障局</p>
